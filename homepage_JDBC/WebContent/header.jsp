		...
		<div class="col-md-12">
			...
			<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
				<div class="container-fluid">
					...
					<%
						String lid = (String) request.getSession(false).getAttribute("login");
					...
					<a class="navbar-brand" href="BoardListForm.jsp" style="color:white" 
					onmouseover="this.style.color='#32cd32'" onmouseout="this.style.color='#ffffff'">BOARD</a>
				</div>
			</nav>
